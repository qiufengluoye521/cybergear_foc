...
void board_init_clock(void)
{
    ...
    clock_add_to_group(clock_femc, 0);//台邦
    ...
    clock_add_to_group(clock_ptpc, 0);//台邦

    clock_add_to_group(clock_puart, 0);
    clock_add_to_group(clock_watchdog0, 0);
    clock_add_to_group(clock_watchdog1, 0);//台邦
    clock_add_to_group(clock_watchdog2, 0);//台邦
    clock_add_to_group(clock_watchdog3, 0);//台邦
    clock_add_to_group(clock_pwdg, 0);//台邦

    clock_add_to_group(clock_qei0, 0);
    clock_add_to_group(clock_qei1, 0);//台邦
    clock_add_to_group(clock_qei2, 0);//台邦
    clock_add_to_group(clock_qei3, 0);//台邦
    clock_add_to_group(clock_qeo0, 0);//台邦
    clock_add_to_group(clock_qeo1, 0);//台邦
    clock_add_to_group(clock_qeo2, 0);//台邦
    clock_add_to_group(clock_qeo3, 0);//台邦
    clock_add_to_group(clock_pwm0, 0);
    clock_add_to_group(clock_pwm1, 0);//台邦
    clock_add_to_group(clock_pwm2, 0);//台邦
    clock_add_to_group(clock_pwm3, 0);//台邦
    clock_add_to_group(clock_rdc0, 0);//台邦
    clock_add_to_group(clock_rdc1, 0);//台邦
    clock_add_to_group(clock_sdm0, 0);//台邦
    clock_add_to_group(clock_sdm1, 0);//台邦
    clock_add_to_group(clock_plb0, 0);//台邦
    clock_add_to_group(clock_sei0, 0);//台邦
    clock_add_to_group(clock_mtg0, 0);//台邦
    clock_add_to_group(clock_mtg1, 0);//台邦
    clock_add_to_group(clock_vsc0, 0);//台邦
    clock_add_to_group(clock_vsc1, 0);//台邦
    clock_add_to_group(clock_clc0, 0);//台邦
    clock_add_to_group(clock_clc1, 0);//台邦
    clock_add_to_group(clock_emds, 0);//台邦
    ...
    clock_add_to_group(clock_crc0, 0);//台邦
    clock_add_to_group(clock_tsns, 0);//台邦
    clock_add_to_group(clock_mbx0, 0);//台邦
    clock_add_to_group(clock_mbx1, 0);//台邦
    clock_add_to_group(clock_gpio, 0);
    clock_add_to_group(clock_ppi0, 0);//台邦
    clock_add_to_group(clock_lobs, 0);//台邦
    clock_add_to_group(clock_rng, 0);//台邦
    clock_add_to_group(clock_sdp, 0);//台邦
    clock_add_to_group(clock_pka, 0);//台邦
    clock_add_to_group(clock_kman, 0);//台邦
    clock_add_to_group(clock_ffa0, 0);//台邦

    clock_add_to_group(clock_usb0, 0);
    clock_add_to_group(clock_esc0, 0);
    clock_add_to_group(clock_eth0, 0);//台邦
    clock_add_to_group(clock_ptp0, 0);//台邦
    clock_add_to_group(clock_ntmr0, 0);//台邦
    ...
    clock_add_to_group(clock_i2c0, 0);//台邦
    clock_add_to_group(clock_i2c1, 0);//台邦
    clock_add_to_group(clock_i2c2, 0);//台邦
    clock_add_to_group(clock_i2c3, 0);
