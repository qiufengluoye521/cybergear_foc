...
#endif
#endif
#define BOARD_CONSOLE_UART_BAUDRATE (115200UL)//(230400UL)//
#endif
#endif
...
/* spi section */
#define BOARD_APP_SPI_BASE              HPM_SPI3//HPM_SPI7
#define BOARD_APP_SPI_CLK_NAME          clock_spi3//clock_spi7
#define BOARD_APP_SPI_IRQ               IRQn_SPI3//IRQn_SPI7
#define BOARD_APP_SPI_SCLK_FREQ         (20000000UL)//(20000000UL)
#define BOARD_APP_SPI_ADDR_LEN_IN_BYTES (2U)//(1U)
#define BOARD_APP_SPI_DATA_LEN_IN_BITS  (16U)//(8U)
#define BOARD_APP_SPI_RX_DMA            HPM_DMA_SRC_SPI3_RX//HPM_DMA_SRC_SPI7_RX
#define BOARD_APP_SPI_TX_DMA            HPM_DMA_SRC_SPI3_TX//HPM_DMA_SRC_SPI7_TX
#define BOARD_SPI_CS_GPIO_CTRL          HPM_GPIO0
#define BOARD_SPI_CS_PIN                IOC_PAD_PC21//IOC_PAD_PF27
...
#define BOARD_ECAT_PHY0_RESET_GPIO_PORT_INDEX GPIO_DI_GPIOV//GPIO_DO_GPIOA
#define BOARD_ECAT_PHY0_RESET_PIN_INDEX       (12)//(10)

#define BOARD_ECAT_PHY1_RESET_GPIO            HPM_GPIO0
#define BOARD_ECAT_PHY1_RESET_GPIO_PORT_INDEX GPIO_DI_GPIOW//GPIO_DO_GPIOA
#define BOARD_ECAT_PHY1_RESET_PIN_INDEX       (12)//(10)
...
#define BOARD_ECAT_IN1_GPIO_PIN_INDEX  (24U)//(31U)

#define BOARD_ECAT_IN2_GPIO            HPM_GPIO0
#define BOARD_ECAT_IN2_GPIO_PORT_INDEX GPIO_DO_GPIOD
#define BOARD_ECAT_IN2_GPIO_PIN_INDEX  (26U)//(9U)

#define BOARD_ECAT_OUT1_GPIO            HPM_GPIO0
#define BOARD_ECAT_OUT1_GPIO_PORT_INDEX GPIO_DO_GPIOD
#define BOARD_ECAT_OUT1_GPIO_PIN_INDEX  (5U)//(8U)

#define BOARD_ECAT_OUT2_GPIO            HPM_GPIO0//BOARD_R_GPIO_CTRL /* reuse RGB red led */
#define BOARD_ECAT_OUT2_GPIO_PORT_INDEX GPIO_DO_GPIOD//BOARD_R_GPIO_INDEX
#define BOARD_ECAT_OUT2_GPIO_PIN_INDEX  (9U)//BOARD_R_GPIO_PIN

#define BOARD_ECAT_OUT_ON_LEVEL (0)//(1) /* ECAT control LED on level */

#define BOARD_ECAT_NMII_LINK0_CTRL_INDEX 1//3
#define BOARD_ECAT_NMII_LINK1_CTRL_INDEX 0
#define BOARD_ECAT_LED_RUN_CTRL_INDEX    2//1
#define BOARD_ECAT_LED_ERROR_CTRL_INDEX  3//6

#define BOARD_ECAT_PHY_ADDR_OFFSET (1U)//(0U)//
...
#define BOARD_APP_ADC16_BASE                    HPM_ADC3//HPM_ADC0
#define BOARD_APP_ADC16_IRQn                    IRQn_ADC3//IRQn_ADC0
#define BOARD_APP_ADC16_UDC_CH                  (7U)//(15U)
#define BOARD_APP_ADC16_TEMP_CH                 (1U)//(15U)
...
#define BOARD_PMSM0_ADC_CH_U                    (14U)//(5U)//(2U)//
#define BOARD_PMSM0_ADC_CH_V                    (10U)//(6U)//(3U)//
#define BOARD_PMSM0_ADC_CH_W                    (11U)//(4U)//(15U)//(7U)//
...
#define BOARD_PMSM0_PWM_TRIG_CMP_INDEX          (16U)//(8U)
#define BOARD_PMSM0_PWM_TRIG_CMP_INDEX_CURRENTLOOP          (17U)//(9U)
#define BOARD_PMSM0_TRIGMUX_IN_NUM              HPM_TRGM0_INPUT_SRC_PWM0_TRGO_0//HPM_TRGM0_INPUT_SRC_PWM1_TRGO_0//HPM_TRGM0_INPUT_SRC_PWM0_CH8REF
...
/*PMSM0 PWM*/
#define BOARD_STEPPER0PWM                 HPM_PWM0//HPM_PWM1//
#define BOARD_PMSM0PWM                    HPM_PWM0//HPM_PWM1//
#define BOARD_PMSM0_UH_PWM_OUTPIN         (0U)//(6U)//
#define BOARD_PMSM0_UL_PWM_OUTPIN         (1U)//(7U)//
#define BOARD_PMSM0_VH_PWM_OUTPIN         (2U)//(4U)//
#define BOARD_PMSM0_VL_PWM_OUTPIN         (3U)//(5U)//
#define BOARD_PMSM0_WH_PWM_OUTPIN         (4U)//(6U)//
#define BOARD_PMSM0_WL_PWM_OUTPIN         (5U)//(7U)//
#define BOARD_PMSM0PWM_TRGM                HPM_TRGM0//HPM_TRGM0
#define BOARD_PMSM0APP_PWM_IRQ             IRQn_PWM0//IRQn_PWM1//
#define BOARD_PMSM0PWM_CMP_INDEX_0         (0U)//(6U)//
#define BOARD_PMSM0PWM_CMP_INDEX_1         (1U)//(7U)//
#define BOARD_PMSM0PWM_CMP_INDEX_2         (2U)//(4U)//
#define BOARD_PMSM0PWM_CMP_INDEX_3         (3U)//(5U)//
#define BOARD_PMSM0PWM_CMP_INDEX_4         (4U)//(2U)//
#define BOARD_PMSM0PWM_CMP_INDEX_5         (5U)//(3U)//
//#define BOARD_BLDCPWM_CMP_TRIG_CMP        (15U)
#define BOARD_BLDC_ADC_SEQ_DMA_SIZE_IN_4BYTES  (40U)//(40U)
#define pwm_output_0                        (0U)
#define PWM_DEAD_AREA_TICK                  (200)
#define PWM_CNT0                            pwm_counter_0
#define BOARD_BLDC_PWM_TRIG_OUT_CHN           (0U)
/*PMSM0 QEI*/
#define BOARD_PMSM0_QEI_BASE                HPM_QEI0//HPM_QEI1//BOARD_BLDC_QEI_BASE//
#define BOARD_PMSM0_QEI_IRQ                 IRQn_QEI0//IRQn_QEI1//BOARD_BLDC_QEI_IRQ//
...
#define HPM_PMSM_ECAT_VERSION                   (1047)    //软件版本号
