...
hpm_stat_t ecat_hardware_init(ESC_Type *esc_ptr)
{
    ...
    esc_config_ctrl_signal_function(esc_ptr, BOARD_ECAT_NMII_LINK1_CTRL_INDEX, esc_ctrl_signal_func_alt_nmii_link1, false);//true);// /* NMII_LINK1 */
#endif
    ...
    //esc_config_nmii_link_source(esc_ptr, false, false, false); /* configure nmii_link source */
    //esc_ptr->GPR_CFG2 &= ~ESC_GPR_CFG2_NMII_LINK0_FROM_IO_MASK;
    //esc_ptr->GPR_CFG2 &= ~ESC_GPR_CFG2_NMII_LINK0_GPR_MASK;
    //esc_ptr->GPR_CFG2 &= ~ESC_GPR_CFG2_NMII_LINK1_FROM_IO_MASK;
    //esc_ptr->GPR_CFG2 &= ~ESC_GPR_CFG2_NMII_LINK1_GPR_MASK;
